Here’s a **very quick, very easy recap** you can remember for future questions 👇

---

## 🔐 Secure Your Network with **Amazon VPC**

### ❓ Why do we need VPC security?
...
## 🧱 The 2 Security Tools (MOST IMPORTANT)

### 1️⃣ **Network Access Control Lists (NACL)**

**Firewall at subnet level**

* Works on **subnets**
* **Stateless** → allow **both inbound & outbound**
* Supports **ALLOW and DENY**
* Default: allow all traffic

👉 Use when you want **extra, broad control**
...
👉 This is your **main and most-used protection**
...
> ❓ *Who is allowed to talk to whom, on which ports, and in which direction?*

AWS solves this using **two firewall layers**:

---

# 🧱 The Two-Layer VPC Security Model

Think of VPC security like a **secure office building** 🏢:

```
Internet
   |
[ Network ACL ]  ← Building gate (subnet-level)
   |
[ Security Group ] ← Office door (instance-level)
   |
[ EC2 Instance ]
```
...
📌 Automatically attached to every subnet
...
### ⚠️ Stateless = Double Work Required
...
❌ If outbound is blocked → browser never gets response
...
> ✔️ Keep NACLs mostly default
> ✔️ Do fine-grained control with Security Groups
...
## 🧩 How NACLs & Security Groups Work Together
...
If either layer blocks traffic → request fails

---

## 🧠 Default Security Strategy (Best Practice)

✔ Leave **NACLs mostly open**
✔ Use **Security Groups** for control
✔ Allow **only required ports**
✔ Restrict SSH to trusted IPs
✔ Use **multiple security groups** if needed
